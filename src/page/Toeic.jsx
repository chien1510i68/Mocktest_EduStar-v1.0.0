                    ...
                    <div className=" grid tablet:grid-cols-2 mobile:grid-cols-1 gap-5 justify-around py-2">
                        <div className="p-3 rounded-lg col-span-1 bg-gradient-to-r from-[#04183b] via-[#00508d] to-[#04183b] md:px-10">
                            ...
                            <div className="grid tablet:grid-cols-3 mobile:grid-cols-1 gap-5 justify-around py-2">
                                ...
                                <button className="text-white duration-300 bg-[#fb9400] my-3 p-2 rounded-md font-bold float-right hover:bg-yellow-500">Luyện tập</button>
                            </div>
                        </div>
                        <div className="p-3 rounded-lg col-span-1 bg-gradient-to-r from-[#04183b] via-[#00508d] to-[#04183b] md:px-10">
                            ...
                            <div className="grid tablet:grid-cols-3 mobile:grid-cols-1 gap-5 justify-around py-2 float-left">
                                ...
                                <button className="text-white col-span-1 duration-300 bg-[#fb9400] my-3 p-2 rounded-md font-bold float-right hover:bg-yellow-500">Luyện tập</button>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div className=" my-5 text-center mx-auto max-w-screen-lg">
                            ...
                            <div className="p-3 grid tablet:grid-cols-3 mobile:grid-cols-1 gap-5 justify-around py-10 " relative data-carousel="slide">
                                <div className="col-span-1 bg-white duration-300 p-5 rounded-lg shadow-md shadow-[#b8b8b8] hover:bg-[#29bdcf] hover:text-white" data-carousel-item>
                                ...
                                <div className="col-span-1 bg-white p-5 duration-300 rounded-lg shadow-md shadow-[#b8b8b8] hover:bg-[#29bdcf] hover:text-white" data-carousel-item>
                                    <div className="flex py-5 gap-5">
