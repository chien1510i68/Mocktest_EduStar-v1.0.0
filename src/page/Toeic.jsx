        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="grid tablet:grid-cols-2 mobile:grid-cols-1 gap-5 justify-around my-10">
            <div className="col-span-1 text-left justify-center my-auto sm:pt-32">
              ...
              <p className="text-left my-5 sm:text-lg">
                EduStar cung cấp miễn phí phần mềm thi trên máy tính. mô phỏng
                phần mềm thi chính thức của Bộ, hỗ trợ thí sinh nắm vững các
                chức năng của phần mềm & ôn luyện các bộ đề thi bám sát định
                dạng, giúp thí sinh tự tin bước vào các kỳ thi chính thức
              </p>
          ...
          <div className="my-10">
            <div className=" my-5 text-center mx-auto max-w-screen-lg">
              <span className="font-bold text-center border-b-2 border-[#fb9400] text-xl py-1">
                Hiểu về bài thi TOEIC
              </span>
            </div>
            <div className="max-w-screen-md">
              <div className="my-5">
                <p className="text-sm">
                  Một bài kiểm tra Toeic(Listening & Reading) thực tế sẽ có 200
                  câu hỏi trắc nghiệm và được chia làm 7 phần.
                </p>
                <p className="text-sm">
                  Trong đó phần nghe (Listening) là từ Path 1 đến Path 4, phần
                  đọc (Reading)sẽ từ Path 5 đến Path 7.
                </p>
              </div>
              <div className="my-5">
                <p className="text-sm">
                  Hầu hết mọi người học Toeic đều muốn thi thử TOEIC Online
                  trước khi tham gia chính thức kỳ thi TOEIC. Một là để làm quen
                  với một bài thi Toeic, thứ 2 là để đánh giá trình độ Toeic của
                  mình đến đâu
                </p>
              </div>
            </div>
          ...
          <div className="grid tablet:grid-cols-4 mobile:grid-cols-1 gap-5 justify-around py-2">
            <div className="shadow-lg border-solid border rounded-md border-[#fb9400] p-3 col-span-1 sm:h-full duration-500 hover:shadow-[#808080]">
              ...
              <p className="text-sm text-[#667085]">
                Thí sinh sẽ nghe 1 lần duy nhất 4 câu mô tả tranh.Sau đó chọn 1
            ...
            <div className="shadow-lg border-solid border rounded-md border-[#fb9400] p-3 col-span-1 duration-500 hover:shadow-[#808080]">
              ...
              <p className="text-sm text-[#667085]">
                Thí sinh nghe 1 lần duy nhất 3 câu hồi đáp cho 1 câu hỏi hoặc 1
            ...
            <div className="shadow-lg border-solid border rounded-md border-[#fb9400] p-3 col-span-1 duration-500 hover:shadow-[#808080]">
              ...
              <p className="text-sm text-[#667085]">
                Thí sinh nghe 1 lần duy nhất các đoạn hội thoại giữa 2 hoặc 3
                người. Mỗi đoạn hội thoại sẽ có 3 câu hỏi, mỗi câu hỏi có 4 lựa
            ...
            <div className="shadow-lg border-solid border rounded-md border-[#fb9400] p-3 col-span-1 duration-500 hover:shadow-[#808080]">
              ...
              <p className="text-sm text-[#667085]">
                Thí sinh sẽ nghe một lần duy nhất các bài nói ngắn. Mỗi bài sẽ
                có 3 câu hỏi, mỗi câu hỏi có 4 lựa chọn. Thí sinh đọc câu hỏi
                sau đó chọn câu trả lời phù hợp nhất.
              </p>
            </div>
          </div>
          ...
          <div className="grid tablet:grid-cols-4 mobile:grid-cols-1 gap-5 justify-around py-2">
            ...
            <div className="shadow-lg border-solid border rounded-md border-[#fb9400] p-3 col-span-1 duration-500 hover:shadow-[#808080]">
              ...
              <p className="text-sm text-[#667085]">
                Chọn đáp án đũng nhất trong 4 đáp án(từ, cụm hoặc câu) để hoàn
            ...
            <div className="shadow-lg border-solid border rounded-md border-[#fb9400] p-3 col-span-1 duration-500 hover:shadow-[#808080]">
              ...
              <p className="text-sm text-[#667085]">
                Thí sinh sẽ đọc các bài đọc hiểu sau đó chọn đáp án đúng nhất
                cho các câu hỏi. Mỗi bài đọc sẽ bao gồm 2-5 câu hỏi.
              </p>
            </div>
          </div>
          <div className=" my-5 text-center mx-auto max-w-screen-lg">
            <span className="font-bold text-center border-b-2 border-[#fb9400] text-xl py-1">
              Mô phỏng bài thi TOEIC
            </span>
          </div>
          <div className=" grid tablet:grid-cols-2 mobile:grid-cols-1 gap-5 justify-around py-2">
            <div className="p-3 rounded-lg col-span-1 bg-gradient-to-r from-[#04183b] via-[#00508d] to-[#04183b] md:px-10">
              ...
              <div className="grid tablet:grid-cols-3 mobile:grid-cols-1 gap-5 justify-around py-2">
                <p className="text-sm text-white col-span-2">
                  Làm bài mini test với số lượng câu hỏi và thời gian giảm một
                  nửa so với bài thi thật
                </p>
                <Button
                  // type="primary"
                  className="text-white mx-auto border-[#013668] bg-[#fb9400] font-bold hover:!border hover:!border-[#fb9400] hover:!shadow-md hover:!text-white"
                  htmlType="submit"
                >
                  {" "}
                  Luyện tập
            ...
            <div className="p-3 rounded-lg col-span-1 bg-gradient-to-r from-[#04183b] via-[#00508d] to-[#04183b] md:px-10">
              ...
              <div className="grid tablet:grid-cols-3 mobile:grid-cols-1 gap-5 justify-around py-2 float-left">
                <p className="text-sm text-white col-span-2">
                  Làm bài full test với số lượng câu hỏi và thời gian giống bài
                  thi thật
                </p>
                <Button className="border-[#013668] mx-auto bg-[#fb9400] font-bold hover:!shadow-md hover:!border-[#fb9400] text-white hover:!bg-[#fb9400] hover:!text-white ">
                  Luyện tập
                </Button>
              </div>
            </div>
          ...
          <div>
            <div className=" my-5 text-center mx-auto max-w-screen-lg">
              <span className="font-bold text-center border-b-2 border-[#fb9400] text-xl py-1">
                Lợi ích khi thi thử TOEIC
              </span>
              <div
                className="p-3 grid tablet:grid-cols-3 mobile:grid-cols-1 gap-5 justify-around py-10 "
                relative
                data-carousel="slide"
              >
                <div
                  className="col-span-1 bg-white duration-300 p-5 rounded-lg shadow-md shadow-[#b8b8b8] hover:bg-[#29bdcf] hover:text-white"
                  data-carousel-item
                >
                  <div className="flex py-5 gap-5">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M11.4333 28.8083C11.1941 28.8083 11 28.6229 11 28.3945V13.7414C11 13.057 11.5833 12.5 12.3 12.5H35.7C36.4167 12.5 37 13.057 37 13.7414V17.8063C37 18.0347 36.8059 18.2201 36.5667 18.2201C36.3275 18.2201 36.1333 18.0347 36.1333 17.8063V13.7414C36.1333 13.5138 35.9383 13.3276 35.7 13.3276H12.3C12.0617 13.3276 11.8667 13.5138 11.8667 13.7414V28.3945C11.8667 28.6229 11.6725 28.8083 11.4333 28.8083Z"
                        fill="#7F56D9"
                        stroke="#FB9400"
                        stroke-width="0.6"
                      />
                      <path
                        d="M24 36.5H19.2333C18.9941 36.5 18.8 36.3146 18.8 36.0862C18.8 35.8578 18.9941 35.6724 19.2333 35.6724H20.1C20.8167 35.6724 21.4 35.1154 21.4 34.431V32.362C21.4 32.1336 21.5941 31.9482 21.8333 31.9482C22.0725 31.9482 22.2667 32.1336 22.2667 32.362V34.431C22.2667 34.8969 22.1046 35.3264 21.8325 35.6724H24C24.2392 35.6724 24.4333 35.8578 24.4333 36.0862C24.4333 36.3146 24.2392 36.5 24 36.5Z"
                        fill="#7F56D9"
                        stroke="#FB9400"
                        stroke-width="0.6"
                      />
                      <path
                        d="M25.0111 32.3621H12.3C11.5833 32.3621 11 31.8051 11 31.1207V28.6379C11 28.4095 11.1941 28.2241 11.4333 28.2241H25.0111C25.2503 28.2241 25.4444 28.4095 25.4444 28.6379C25.4444 28.8663 25.2503 29.0517 25.0111 29.0517H11.8667V31.1207C11.8667 31.3483 12.0617 31.5345 12.3 31.5345H25.0111C25.2503 31.5345 25.4444 31.7198 25.4444 31.9483C25.4444 32.1767 25.2503 32.3621 25.0111 32.3621Z"
                        fill="#7F56D9"
                        stroke="#FB9400"
                        stroke-width="0.6"
                      />
                      <path
                        d="M28.7667 18.2929H33.1C33.3392 18.2929 33.5333 18.1075 33.5333 17.8791C33.5333 17.6507 33.3392 17.4653 33.1 17.4653H28.7667C28.5275 17.4653 28.3333 17.6507 28.3333 17.8791C28.3333 18.1075 28.5275 18.2929 28.7667 18.2929Z"
                        fill="#7F56D9"
                        stroke="#FB9400"
                        stroke-width="0.6"
                      />
                      <path
                        d="M30.5 34.8447H31.3667C31.6059 34.8447 31.8 34.6593 31.8 34.4309C31.8 34.2025 31.6059 34.0171 31.3667 34.0171H30.5C30.2608 34.0171 30.0667 34.2025 30.0667 34.4309C30.0667 34.6593 30.2608 34.8447 30.5 34.8447Z"
                        fill="#7F56D9"
                        stroke="#FB9400"
                        stroke-width="0.6"
                      />
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
                        d="M27.0333 36.5002H34.8333C36.0285 36.5002 37 35.5725 37 34.4312V17.8795C37 16.7383 36.0285 15.8105 34.8333 15.8105H27.0333C25.8382 15.8105 24.8667 16.7383 24.8667 17.8795V34.4312C24.8667 35.5725 25.8382 36.5002 27.0333 36.5002ZM25.7333 17.8795C25.7333 17.1951 26.3166 16.6381 27.0333 16.6381H34.8333C35.5501 16.6381 36.1333 17.1951 36.1333 17.8795V34.4312C36.1333 35.1157 35.5501 35.6726 34.8333 35.6726H27.0333C26.3166 35.6726 25.7333 35.1157 25.7333 34.4312V17.8795Z"
                        fill="#7F56D9"
                      />
                      <path
                        d="M34.8333 36.2002H27.0333V36.8002H34.8333V36.2002ZM36.7 34.4312C36.7 35.3939 35.876 36.2002 34.8333 36.2002V36.8002C36.181 36.8002 37.3 35.7511 37.3 34.4312H36.7ZM36.7 17.8795V34.4312H37.3V17.8795H36.7ZM34.8333 16.1105C35.876 16.1105 36.7 16.9169 36.7 17.8795H37.3C37.3 16.5597 36.181 15.5105 34.8333 15.5105V16.1105ZM27.0333 16.1105H34.8333V15.5105H27.0333V16.1105ZM25.1667 17.8795C25.1667 16.9169 25.9907 16.1105 27.0333 16.1105V15.5105C25.6857 15.5105 24.5667 16.5597 24.5667 17.8795H25.1667ZM25.1667 34.4312V17.8795H24.5667V34.4312H25.1667ZM27.0333 36.2002C25.9907 36.2002 25.1667 35.3939 25.1667 34.4312H24.5667C24.5667 35.7511 25.6857 36.8002 27.0333 36.8002V36.2002ZM27.0333 16.3381C26.1641 16.3381 25.4333 17.0165 25.4333 17.8795H26.0333C26.0333 17.3737 26.4691 16.9381 27.0333 16.9381V16.3381ZM34.8333 16.3381H27.0333V16.9381H34.8333V16.3381ZM36.4333 17.8795C36.4333 17.0165 35.7026 16.3381 34.8333 16.3381V16.9381C35.3976 16.9381 35.8333 17.3737 35.8333 17.8795H36.4333ZM36.4333 34.4312V17.8795H35.8333V34.4312H36.4333ZM34.8333 35.9726C35.7026 35.9726 36.4333 35.2942 36.4333 34.4312H35.8333C35.8333 34.9371 35.3976 35.3726 34.8333 35.3726V35.9726ZM27.0333 35.9726H34.8333V35.3726H27.0333V35.9726ZM25.4333 34.4312C25.4333 35.2942 26.1641 35.9726 27.0333 35.9726V35.3726C26.4691 35.3726 26.0333 34.9371 26.0333 34.4312H25.4333ZM25.4333 17.8795V34.4312H26.0333V17.8795H25.4333Z"
                        fill="#FB9400"
                      />
                    </svg>

                    <p className="py-3 font-bold">Ngân hàng đề thi</p>
                  </div>

                  <p className="text-left">
                    Ngân hàng đề thi đa dạng với nhiều chủ đề khác nhau sẽ giúp
                    bạn chuần bị tốt nhất cho kỳ thi của mình
                  </p>
                </div>
                <div
                  className="col-span-1 bg-white p-5 duration-300 rounded-lg shadow-md shadow-[#b8b8b8] hover:bg-[#29bdcf] hover:text-white"
                  data-carousel-item
                >
                  <div className="flex py-5 gap-5">
                    <svg
                  ...
                  <p className="text-left">
                    Các bài thi thử có cấu trúc như bài thi thật sẽ giúp bạn
                    vượt qua kỳ thi một cách thành công
                  </p>
                </div>
                <div
                  className="col-span-1 bg-white p-5 duration-300 rounded-lg shadow-md shadow-[#b8b8b8] hover:bg-[#29bdcf] hover:text-white"
          ...
          <div className="px-3">
            <div className=" my-5 text-center mx-auto max-w-screen-lg">
              <span className="font-bold text-center border-b-2 border-[#fb9400] text-xl py-1">
                Lưu ý khi làm đề thi thử TOEIC online
              </span>
            </div>
            <div className="mobile:my-5 grid tablet:grid-cols-2 mobile:grid-cols-1 gap-10 justify-center">
              <div className="col-span-1 text-left tablet:ml-[10%] mobile:ml-2">
                <p className="my-3 text-sm">
                  Để việc ôn luyện đề thi thử Toeic online được hiệu quả tốt
                  nhất có thể, học viên nên lưu ý những vấn đề sau đây:
                </p>
                <ul className="">
                  <li className="px-2 my-1 text-sm list-disc">
                    Học viên nghiêm túc và làm bài thi giống như khi ̣thi thật,
                    không sử dụng tài liệu trong qúa trình làm bài.
                  </li>
                  <li className="px-2 my-1 text-sm list-disc">
                    Làm bài thi nên sử dụng máy tính để bàn hoặc laptop để đạt
                    hiệu qủa tốt nhất.
                  </li>
                  <li className="px-2 my-1 text-sm list-disc">
                    Luyện nghe loa ngoài để làm quen dần với âm thanh và cải
                    thiện trình độ nghe Toeic của mình.
                  </li>
                  <li className="px-2 my-1 text-sm list-disc">
                    Làm đúng thời gian quy định.
                  </li>
                  <li className="px-2 my-1 text-sm list-disc">
                    Tập trung làm hết bài thi không bỏ dở giữa chừng.
                  </li>
                  <li className="px-2 my-1 text-sm list-disc">
                    Sau khi thi kiểm tra lỗi sai, phân tích lỗi sai và tìm ra
                    giải pháp cho câu hỏi.
                  </li>
                </ul>
              </div>
              <div className="col-span-1">
